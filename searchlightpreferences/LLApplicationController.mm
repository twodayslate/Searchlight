...
-(void) setPreferenceValue:(id)value specifier:(PSSpecifier*)specifier {
	...
	//NSDictionary *exampleTweakSettings = [NSDictionary dictionaryWithContentsOfFile:exampleTweakPreferencePath];
	//char[] *stri = 
	CFStringRef mikotoPost = CFStringCreateWithCString(NULL, [specifier.properties[@"PostNotification"] UTF8String], kCFStringEncodingMacRoman);
	if(mikotoPost) CFNotificationCenterPostNotification(CFNotificationCenterGetDarwinNotifyCenter(), mikotoPost, NULL, NULL, YES);
}
